          ...
          <div className="file-tree w-full">
            {
              Object.keys(fileTree).map((file,indx) => (
                <button  
                  ...
                  key={indx} className="tree-element cursor-pointer p-2 px-4 flex items-center gap-2 bg-slate-300 w-full">
                  <p
                    className=" font-semibold text-mg"
                  >{file}</p>
                </button>
              ))
                ...
                <div className="files flex">
                  {
                    openFiles.map((file, index) => (
                        <button
                            ...
                            className={`open-file cursor-pointer p-2 px-4 flex items-center w-fit gap-2  ${ currentFile === file ? 'bg-[#1a1b26] text-white' : 'bg-slate-300'}`}>
                            <p
